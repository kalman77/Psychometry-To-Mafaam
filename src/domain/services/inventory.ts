...
import type { DomainInventory } from './inventory/domain-inventory.ts';
import type { Inventory } from './inventory/inventory.ts';

export type { DomainInventory } from './inventory/domain-inventory.ts';
export type { Inventory } from './inventory/inventory.ts';
